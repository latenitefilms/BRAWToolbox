...
After running BRAW Toolbox you can enable and disable the Media Extension in:

**System Settings > General > Login Items & Extensions**

If you scroll down **Extensions** then make sure BRAW Toolbox has the three Media Extensions enabled:
